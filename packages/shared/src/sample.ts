...
export const sampleAgents: AgentProfile[] = [
  {
    ...
    notes: "Use this demo profile to orchestrate multiple specialists and compare their outputs.",
  ...
  },
  {
    ...
    notes: "Useful for market scans, requirement extraction, and problem framing.",
  ...
  },
  {
    ...
    notes: "Focused on implementation sequencing, architecture, and delivery details.",
